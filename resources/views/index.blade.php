                ...
                <form action="{{ Route::is('show*') ? route('update', ['customer' => $customer]) : route('store') }}"
                    ...
                    <div class="mb-3">
                        ...
                        <select
                            ...
                            <option value="0"
                                {{ (!Request::is('customer/create')? $customer->jenis_kelamin ?? old('jenis_kelamin'): old('jenis_kelamin')) == 0? 'selected': null }}>
                                Laki - laki</option>
                            <option value="1"
                                {{ (!Request::is('customer/create')? $customer->jenis_kelamin ?? old('jenis_kelamin'): old('jenis_kelamin')) == 1? 'selected': null }}>
                                Perempuan</option>
                        </select>
                    ...
                    @foreach ($customers as $c)
                        <li class="list-group-item d-flex">
                            ...
                            <form action="{{ route('delete', ['customer' => $c]) }}" method="POST">
                                @csrf
                                <button type="submit"
                                    class="text-decoration-none text-danger btn p-0 m-0 ms-2">Delete</button>
                            </form>
                        </li>
                    @endforeach
                </ul>
